...
class CanberraTest : BehaviorSpec({
    var tableau: Tableau
    var foundation: Foundation
    Given("Canberra game") {
        val canberra = Canberra
        When("Initialized") {
            Then("baseDeck should contain 52 cards by suit") {
                canberra.baseDeck shouldBe tc.deck
            }
        }
        When("canAddToTableau is called") {
            And("cardsToAdd is empty") {
                tableau = Tableau(TableauZero)
                val result = canberra.canAddToTableau(tableau, emptyList())
            ...
            And("Tableau contains card trying to be added") {
                ...
                val result = canberra.canAddToTableau(tableau, listOf(tc.card5SFU))
                Then("Result should be false") {
                    result shouldBe false
                }
            }
            And("Tableau is not empty") {
                ...
                And("The first card of cardsToAdd is the same suit as last card of Tableau") {
                    And("Descending") {
                        val result = canberra.canAddToTableau(tableau, tc.multiSuitInOrder)
                        Then("Result should be true") {
                            result shouldBe true
                        }
                    }
                    And("Not in order") {
                        val result = canberra.canAddToTableau(tableau, tc.sameSuitNotInOrder)
                        Then("Result should be false") {
                            result shouldBe false
                        }
                    }
                ...
                And("The first card of cardsToAdd is not the same suit as last card of Tableau") {
                    val result = canberra.canAddToTableau(tableau, listOf(tc.card7HFU))
                    Then("Result should be false") {
                        result shouldBe false
                    }
                }
            ...
            And("Tableau is empty") {
                ...
                And("cardToAdd starts with a King") {
                    val result = canberra.canAddToTableau(tableau, listOf(tc.card13HFU))
                    Then("Result should be true") {
                        result shouldBe true
                    }
                }
                And("cardToAdd does not start with a King") {
                    val result = canberra.canAddToTableau(tableau, listOf(tc.card10HFU))
                    Then("Result should be false") {
                        result shouldBe false
                    }
                }
        ...
        When("canAddToFoundation is called") {
            ...
            And("cardToAdd is the correct Suit") {
                And("The correct next value") {
                    val result = canberra.canAddToFoundation(foundation, tc.card7CFU)
                    Then("Result should be true") {
                        result shouldBe true
                    }
                }
                And("Not the correct next value") {
                    val result = canberra.canAddToFoundation(foundation, tc.card8CFU)
                    Then("Result should be false") {
                        result shouldBe false
                    }
                }
            ...
            And("cardToAdd is not the correct Suit") {
                And("The correct next value") {
                    val result = canberra.canAddToFoundation(foundation, tc.card7HFU)
                    Then("Result should be false") {
                        result shouldBe false
                    }
                }
                And("Not the correct next value") {
                    val result = canberra.canAddToFoundation(foundation, tc.card8HFU)
                    Then("Result should be false") {
                        result shouldBe false
                    }
                }
        ...
        When("autocompleteTableauCheck is called") {
            And("Tableau contains multiple Suits") {
                ...
                val result = canberra.autocompleteTableauCheck(List(7) { tableau })
                Then("Result should be false") {
                    result shouldBe false
                }
            }
        ...
        When("resetTableau is called") {
            ...
            canberra.resetTableau(tableauList, Stock(tc.deck))
        ...
        When("resetFoundation is called") {
            ...
            canberra.resetFoundation(foundationList, Stock())
            Then("Piles should be") {
        ...
        When("gameWon is called") {
            ...
            And("Not all 4 counted piles are valid") {
                ...
                val result = canberra.gameWon(foundationList)
                Then("Result should be false") {
                    result shouldBe false
                }
            }
            And("All 4 counted piles are valid") {
                ...
                val result = canberra.gameWon(validList + invalidList)
                Then("Result should be true") {
                    result shouldBe true
                }
            }
