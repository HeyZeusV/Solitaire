 ...
 *  @property animatedCards The [Cards][CardLogic] moving from [start] pile to [end] pile.
 ...
 *  @property tableauCardFlipInfo Determines if the last [CardLogic] of a [Tableau] pile needs to be
 *  flipped.
...
data class AnimateInfo(
    val start: GamePiles,
    val end: GamePiles,
    val animatedCards: List<CardLogic>,
