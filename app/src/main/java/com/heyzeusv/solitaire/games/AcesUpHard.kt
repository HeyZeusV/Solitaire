...
data object AcesUpHard : Games.AcesUpVariants() {
    /**
     ...
     *  [GameInfo]
     */
    override val nameId: Int = R.string.games_aces_up_hard
    ...
    override val dataStoreEnum: Game = Game.GAME_ACES_UP_HARD
    override val dbName: String = "acesUpHard"
